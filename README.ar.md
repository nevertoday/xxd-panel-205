...
# XXD Panel 205｜كولاج صور وخطوط بأشكال عضوية دافئة
...
كولاج صور وخطوط بأشكال عضوية دافئة
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 205 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-205`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-205 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-205-prompt.en.md) أو [بالصينية](references/xxd-panel-205-prompt.zh-CN.md).
